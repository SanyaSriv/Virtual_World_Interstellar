...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        let elem1 = (other1.elements[1] * other2.elements[2]) - (other1.elements[2] * other2.elements[1]);
        let elem2 = - ((other1.elements[0] * other2.elements[2]) - (other1.elements[2] * other2.elements[0]));
        let elem3 = (other1.elements[0] * other2.elements[1]) - (other1.elements[1] * other2.elements[0]);
        let v3 = new Vector3([elem1, elem2, elem3]); // Modify this line to calculate cross product between other1 and other2.
    ...
    magnitude() {
        // Insert your code here.
        let m = ((this.elements[0] ** 2) + (this.elements[1] ** 2) + (this.elements[2] ** 2)) ** 0.5; // Modify this line to calculate this vector's magnitude.
